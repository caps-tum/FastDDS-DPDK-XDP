...
//    }
            ...
            bool DPDKTransport::init(const PropertyPolicy *properties, const uint32_t &max_msg_size_no_frag) {
            ...
            bool DPDKTransport::IsLocatorSupported(const eprosima::fastdds::rtps::Locator &locator) const {
                return locator.kind == DPDKTransport::transport_kind_;
            }

            bool DPDKTransport::is_locator_allowed(const eprosima::fastdds::rtps::Locator &locator) const {
                return IsLocatorSupported(locator);
            }

            Locator DPDKTransport::RemoteToMainLocal(const Locator &remote) const {
                Locator locator = {
...
//        );
            ...
            bool DPDKTransport::DoInputLocatorsMatch(const Locator &locator, const Locator &locator1) const {
                return locator.kind == locator1.kind;
            }

            LocatorList DPDKTransport::NormalizeLocator(const Locator &locator) {
                // If this is an address referring to multiple interfaces, then do a check whether they are allowed
            ...
            void DPDKTransport::select_locators(LocatorSelector &selector) const {

            }

            bool DPDKTransport::is_local_locator(const Locator &locator) const {
                assert(locator.kind == transport_kind_);
                return memcmp(
            ...
            void DPDKTransport::AddDefaultOutputLocator(LocatorList &defaultList) {
                Locator locator;
            ...
            void DPDKTransport::setLocatorBroadcastAddress(Locator &locator) {
                // FF:FF:FF:FF:FF:FF
                memset(locator.address, 0, 10);
                memset(&locator.address[10], 0xFF, 6);
            }

            bool DPDKTransport::getDefaultMetatrafficMulticastLocators(LocatorList &locators,
            ...
            bool DPDKTransport::getDefaultMetatrafficUnicastLocators(LocatorList &locators,
            ...
            bool DPDKTransport::getDefaultUnicastLocators(LocatorList &locators, uint32_t unicast_port) const {
                return false;
            }

            bool DPDKTransport::fillMetatrafficMulticastLocator(Locator &locator,
                                                                uint32_t metatraffic_multicast_port) const {
                return false;
            }

            bool
            DPDKTransport::fillMetatrafficUnicastLocator(Locator &locator, uint32_t metatraffic_unicast_port) const {
                return false;
            }

            bool DPDKTransport::configureInitialPeerLocator(Locator &locator, const PortParameters &port_params,
                                                            uint32_t domainId, LocatorList &list) const {
                return false;
            }

            bool DPDKTransport::fillUnicastLocator(Locator &locator, uint32_t well_known_port) const {
                return false;
            }
